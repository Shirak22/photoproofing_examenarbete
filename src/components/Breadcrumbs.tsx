...
export default function Breadcrumbs() {
  ...
  const [segmentNames, setSegmentNames] = useState<{name:string, href:string}[]>([]);
  ...
  return (
    <nav className="flex ml-2 mb-20" aria-label="Breadcrumb">
      <ol role="list" className="flex items-center ">
        ...
        {
         segmentNames && segmentNames.map((segment, index) => {
