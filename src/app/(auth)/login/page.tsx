...
export default function AuthLogin() {
  ...
  return (
    <>
      <div className="flex h-full flex-1 flex-col justify-center py-12 px-8 bg-gray-100">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
          <div className="bg-white px-6 py-12 rounded-2xl sm:px-12">
            ...
            <div>
              ...
              <form
                ...
                className="mt-6 grid grid-cols-1 gap-4 hover:cursor-pointer"
              >
